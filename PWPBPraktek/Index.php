...
<body style="background-color: #143d59;">
...
<br><br>
<a class="btn btn-warning" href="add.php" role="button" style="margin-left: 500px">Add Car</a>
...
<br></br>
    ...
    <tr style="color: #f4b41a;">
        <th>Id</th><th>Mobil</th> <th>Harga</th> <th>Gambar</th> <th>Edit</th>
    </tr>
    <?php  
    while($user_data = mysqli_fetch_array($query)) {         
        echo "<tr style='color: #f4b41a;'>";
